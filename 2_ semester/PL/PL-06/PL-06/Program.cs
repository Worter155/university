...
namespace PL_06
{
    public class Program
    {
        ...
        {
            Task task = null;
            Console.WriteLine("Лабораторная работа No6\nВыполнил студент группы 6102 Москалев Андрей");
            Console.WriteLine("\nВведите траекторию программы через пробел: ");
                ...
                switch (Console.ReadLine())
                {
                    case "1":
                        try
                        {
                            ...
                            int l = int.Parse(Console.ReadLine());
                            IVectorable vector = new ArrayVector(l);
                            Console.WriteLine("Заполните массив");
                            ...
                            Vectors.OutputVector(vector, file1);
                            file1.Close();
                            Console.WriteLine("Вектор успешно сохранен в файл test.dat");
                            Console.ReadLine();
                        }
                        catch (Exception e)
                        {
                    ...
                    case "2":
                        try
                        {
                            ...
                            Console.WriteLine("Чтение вектора с файла test.dat через байтовый поток");
                            Console.WriteLine();
                    ...
                    case "3":
                        try
                        {
                            ...
                            Vectors.WriteVector(vector, file3);
                            file3.Close();
                            Console.WriteLine("Вектор успешно сохранен в файл test.txt");
                            Console.ReadLine();
                        }
                        catch (Exception e)
                        {
                    ...
                    case "4":
                        try
                        {
                            ...
                            Console.WriteLine("Чтение вектора с файла test.txt через символьный поток");
                            Console.WriteLine(vector.ToString());
                            Console.ReadLine();
                        }
                        catch (Exception e)
                    ...
                    case "5":
                        try
                        {
                            ...
                            binFormat.Serialize(stream, vector);             
                            Console.WriteLine("Вектор успешно сохранен в файл test.bin с помощью сериализации");
                            ...
                            if (vector.Equals(vector2)) Console.WriteLine("Вектора равны");
                            else Console.WriteLine("Вектора не равны");
                            Console.ReadLine();
                        }
                        catch (Exception e)
